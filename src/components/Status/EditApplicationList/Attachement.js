...
const Fileupload = forwardRef((props, ref) => {
  ...
  const submit = async (e) => {
    ...
    const url =
      'https://epassportservices.azurewebsites.net/Request/api/V1.0/RequestAttachments/UploadChangeAttachment';
    ...
    <div>
      {loading ? (
        ...
        <form onSubmit={(e) => submit(e)}>
          ...
          {inputs}
          <button className="btn btn-primary float-right mr-3" type="submit">
            Upload
          </button>
        </form>
      )}
