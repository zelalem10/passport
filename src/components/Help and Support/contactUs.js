...
const ContactUs = () => {
    ...
    const validate = () => {
        ...
        if (firstNameError || lastNameError || phoneNumberError || emailError || noteError) {
    ...
    const LogInSubmit = (e) => {
        ...
        if (isValid) {
            ...
            axios({
                ...
                method: 'post',
                url: 'https://epassportservices.azurewebsites.net/Transactional/api/V1.0/Feedback/Create',
                data: {
                    firstName: firstName,
                    lastName: lastName,
                                    ...
                                    <div class='card p-4'>
                                    {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 medium text-center">
                                                <MDBBtn type="submit" class="btn btnBlu">Submit</MDBBtn>
                                            </div>
                                        </div>
