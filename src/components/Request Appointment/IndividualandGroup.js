...
<div class="small-12 medium-6 column">
               <a class="card card--link card--teal card--tile" onClick={()=>continueIndividual('individual')}>
                  <div class="card__content">
                  <i class="fas fa-user fa-7x"></i>
                     <p class="vertical-margin-1"><span class="text-link--more-big text-link--light text-center">Start Individual Appointment</span><i class="fas fa-arrow-circle-right fa-2x arrow-icon-group"></i></p>
                  </div>
               </a>
            </div>
            <div class="small-12 medium-6 column vertical-margin-1-small vertical-margin-0-medium">
               <a class="card card--link card--teal card--tile" onClick={()=>continueTo('group')}>
                  <div class="card__content">
                  <i class="fas fa-users fa-7x"></i>
                     <p class="vertical-margin-1"><span class="text-link--more-big text-link--light text-center">Start Group Appointment</span><i class="fas fa-arrow-circle-right fa-2x arrow-icon-group"></i></p>
                  </div>
               </a>
            </div>
</div>
         ...
         <ul class="vertical-margin-0">
            <li >
               <ul class="list--no-bullets list--single-line list--border">
                  <li ><a  href="tel:8008817385"><span  class="show-for-sr">Call us at:</span><i class="fas fa-phone"></i> 800-881-7385 </a></li>
                  <li ><a  href="tel:6147226200"><span  class="show-for-sr">Call us at:</span><i class="fas fa-phone"></i> 614-722-6200 </a></li>
