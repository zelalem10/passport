...
<a class="small-12 column row card--link vertical-margin-1" onClick={continueTo}>
   <div class="small-12 medium-4 column card card--small-gutters card--teal flex flex--column align-center text-center">
...
<a class="small-12 column row card--link vertical-margin-1">
   ...
   <div class="small-12 medium-8 column card card--small-gutters card--gray rtf rtf--small bold">
      <p>If your child has a diagnosis, problem or condition that you would like to seek out additional pediatric expert advice for, please select this type of appointment.</p>
   </div>
</a>
<a class="small-12 column row card--link vertical-margin-1 ">
   <div class="small-12 medium-4 column card card--small-gutters card--teal flex flex--column align-center text-center">
   ...
   <div class="small-12 medium-8 column card card--small-gutters card--gray rtf rtf--small bold">
      <p>International families should use this option to get in touch with our welcome service team who can connect you with a Nationwide Children’s expert to get you the advice you need.</p>
   </div>
</a>
        </div>
        </div>
        </div>
        <a class="button hollow gray vertical-margin-2 " onClick={backTo} ><i class="fas fa-arrow-left" ></i> Previous<span class="show-for-medium"> Screen</span></a>
        </div>
    </MDBCol>
