...
<MDBRow>
    <MDBCol sm="12" md="8" lg="7">
      ...
      <div>
        <select className="browser-default custom-select" onChange={props.handleChange()} value={props.values}>
      ...
      <a class="button hollow gray vertical-margin-2 ng-star-inserted" onClick={backTo} ><i class="fas fa-arrow-left"></i> Previous<span class="show-for-medium"> Screen</span></a>
      <a class="specialty-next-step button float-right vertical-margin-2" onClick={continueTo}> Next <i class="fas fa-arrow-right"></i></a>
      </div>
            </MDBCol>
