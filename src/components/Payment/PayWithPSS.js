...
const PayWithPSS = () => {
    ...
    const localConfig = {
        headers: {
             Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJKV1RfQ1VSUkVOVF9VU0VSIjoiYXRhbGF5IiwibmJmIjoxNjAxMzcwMDIyLCJleHAiOjE2MDEzODQ0MjIsImlhdCI6MTYwMTM3MDAyMn0.WB-wbxZCoOP7LnUHLu_UHpznFg9gtH11_JH9ipXHRHs",
             'content-type': 'application/json',
             'Accept': 'application/json'
    }
    };
    const prodURL="https://epassportservices.azurewebsites.net/Payment/api/V1.0/Payment/OrderRequest"
    ...
    (responseGot===true?(<div>{ ReactHtmlParser(contentResponse, options) }</div>):(null))
    )
}
