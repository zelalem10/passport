...
class SignUp extends Component {
  ...
  validate = () => {
    ...
    if (!this.state.userRequest.passwordTwo) {
      ...
      this.state.userRequest.password !== this.state.userRequest.passwordTwo
    ) {
  ...
  submitHandler = (e) => {
    ...
    if (isValid) {
      axios({
        ...
        url:
          'https://epassportservices.azurewebsites.net/api/Request/V1.0/RequestAttachments/UploadAttachment',
                  ...
                  <div className="header pt-3 mb-5 textBackground">
                    <MDBRow className="d-flex justify-content-center white-text">
                      <h4 className="white-text my-3 py-3 font-weight-bold">
                        <span class="fa fa-user-plus mr-2"></span> Sign Up{' '}
                      </h4>
                    </MDBRow>
                  </div>
