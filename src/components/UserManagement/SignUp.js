...
class SignUp extends Component {
  ...
  validate = () => {
    ...
    if (firstNameError || lastNameError || emailError || passwordError || passwordTwoError || phoneNumberError || ReCAPTCHAError) {
      this.setState({ firstNameError, MiddleNameError, lastNameError, emailError, passwordError, passwordTwoError, phoneNumberError, ReCAPTCHAError })
  ...
  render() {
    ...
    return (
      ...
      <MDBContainer className="passport-card-deck passport-container my-3 p-5" fluid>
...
<ReCAPTCHA
                  ...
                  />
                    ...
                    <div className='red-text ml-5'>{this.state.ReCAPTCHAError}</div>
                  ) : null}
</div>
                    </div>
          ...
          <div class="card p-2">
                        <div class="card-body">
                        <div class="u-center-text u-margin-bottom-big"><h2 class="heading-secondary">Member Benefits</h2></div>
                            <h4>Members get more</h4>
                            <p>Members save up to 10% more when booking directly on our website or mobile app.</p>
                            <h4>Points for hotel stays</h4>
                            <p>Earn points per US dollar spent on eligible stays and food and beverage purchases charged to your room during an eligible stay.</p>
                            <h4>Free award nights</h4>
                            <p>Redeem for Free Award Nights starting at 9,000 points with no blackout dates on Standard Rooms.</p>
                            <h4>Phone</h4>
                            <p>8133 FREE CALL</p>
